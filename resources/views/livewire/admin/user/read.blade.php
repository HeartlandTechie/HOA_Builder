            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style='cursor: pointer' wire:click="sort('is_superuser')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'is_superuser') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'is_superuser') fa-sort-amount-up ml-2 @endif'></i> {{ __('Is_superuser') }} </td>
