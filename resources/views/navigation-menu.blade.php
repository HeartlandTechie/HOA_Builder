<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
           ...
           <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('checklist') }}" :active="request()->routeIs('checklist')">
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('calendar') }}">
                                {{ __('Calendar') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('reservation') }}">
                                {{ __('Reservation') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('checklist') }}">
                                {{ __('System Check List') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('minutes') }}">
                                {{ __('Minutes') }}
                            </x-jet-dropdown-link>
